...
var tableCarteraCreditos;
var divLoading = document.querySelector('#divLoading');
document.addEventListener('DOMContentLoaded', function(){
    persona_natural();
});

$('#tableCarteraCreditos').DataTable();

function persona_natural(){
   
    tableCarteraCreditos = $('#tableCarteraCreditos').dataTable( {
        "aProcessing":true,
        "aServerSide":true,
        "language": {
        ...
        "ajax":{
            "url": " "+base_url+"/Creditos/getTotalCreditos",
            "dataSrc":""
...
function persona_juridica(){
    ...
    tableCarteraCreditos = $('#tableCarteraCreditos').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Creditos/getTotalCreditosDos",
            "dataSrc":""
