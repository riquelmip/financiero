  ...
  $.ajax({
    ...
    function(inputValue){
     ...
     if (inputValue===false) {
        ...
        var datos_insert = {"iddetalle": iddetalle,"mes": mes, "fecha": fecha, "cuota": cuota, "saldofinal": saldofinal, "tasa": tasa, "meses": meses, "abonoCapital": abonoCapital,"mora":mora};
