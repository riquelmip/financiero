    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table table-bordered">
          <tbody>
            <tr>
              <td>Numero de Cliente Natural:</td>
            ...
            <tr>
              <td>Boleta de Pagos:</td>
              <td id="celBoleta">Larry</td>
            </tr>
            <tr>
              <td>Categoria:</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table table-bordered">
          <tbody>
            <tr>
              <td>Numero de Cliente Juridico:</td>
              <td id="celDui2">654654654</td>
            </tr>
            <tr>
              <td>Nombre de la Empresa:</td>
              <td id="celNit2">654654654</td>
            </tr>
            <tr>
              <td>Dirección:</td>
            ...
            <tr>
              ...
              <td id="celTelefono2">Larry</td>
            </tr>
            <tr>
              <td>Estado de Resultado:</td>
              <td id="celEmail2">Larry</td>
            </tr>
            <tr>
              <td>Categoria:</td>
              <td id="celTipoUsuario2">Larry</td>
            </tr>
...
<!-- Modal -->
<div class="modal fade" id="modalFormFiador" tabindex="-1" role="dialog" aria-hidden="true">
