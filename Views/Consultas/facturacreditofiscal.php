...
$pdf->Image('Views/Consultas/img/rectangulo.png',150,11,50);
$pdf->SetFont('Arial','B',10);   
$pdf->Text(154, 18, utf8_decode('Factura de Credito Fiscal'));
$pdf->SetFont('Arial','B',10);   
$pdf->Text(154, 25, utf8_decode('NIT   :0615-050900-111-3'));
$pdf->SetFont('Arial','B',10);   
$pdf->Text(154, 30, utf8_decode('NRC :1000001-1'));
...
$header = array("", "");
$data2 = array(
    array("IVA 13%", SMONEY.number_format(floatval($data['iva']), 2, ',', ' ')),
    array("Subtotal",SMONEY.number_format(floatval($data['subtotal']), 2, ',', ' ')),
    
    array("+ IVA Percibido", '-'),
    array("- IVA Retenido", '-'),
    array("Venta no Sujeta", '-'),
    array("Venta Exenta", '-'),
