          ...
          <div class="tile">
            <div class="tile-body">
              <form id="formCargos" name="formCargos">
                <input type="hidden" id="id_configuracion" name="id_configuracion" value="">
                <div class="form-group">
                  <label class="control-label">Nombre</label>
                  <input class="form-control" autocomplete="off"  id="txttiempo_incobrable" name="txttiempo_incobrable" type="text" placeholder="Nombre de la Configuracion" required="">
                </div>
